const content = {
  purpose: {
    title: 'PURPOSE',
    body: 'as a coach is to develop complete athletes—young people who excel in basketball, embrace hard work, and carry a deep love for the game. Through a visionary approach to player development, I empower athletes to reach their full potential on and off the court. I am committed to providing high-level training, inspiring confidence, and building pathways to future opportunities, whether in college, professional basketball, or personal growth. Driven by dedication to my community, I strive to create an environment where every player can thrive.',
  },
  trainingVideos: {
    private: [
      {
  ...
  gallery: [
    ...
    { src: '/images/gallery/34.jpeg', alt: 'gallery 34' },
    ...
    { src: '/images/gallery/16.jpeg', alt: 'gallery 16' },

    { src: '/images/gallery/17.jpeg', alt: 'gallery 17' },
    { src: '/images/gallery/18.jpeg', alt: 'gallery 18' },
    { src: '/images/gallery/19.jpeg', alt: 'gallery 19' },

    { src: '/images/gallery/33.jpeg', alt: 'gallery 33' },
  ],
  pricing: {
